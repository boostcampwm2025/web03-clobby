// 인증 로직이 들어온다.
import { CanActivate, ExecutionContext, HttpException, Injectable, UnauthorizedException, type LoggerService } from "@nestjs/common";
...
export class JwtGuard implements CanActivate {
  constructor(
    private readonly authUsecase : JwtAuth<unknown>,
  ) {}
  ...
  public async canActivate(context: ExecutionContext): Promise<boolean>  {
    ...
    const access_token = this.extractBearerToken(
