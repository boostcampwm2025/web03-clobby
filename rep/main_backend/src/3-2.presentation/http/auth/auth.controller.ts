...
import { Body, Controller, Delete, Get, HttpCode, Post, Req, Res, UseGuards, UsePipes, ValidationPipe } from "@nestjs/common";
import { ConfigService } from "@nestjs/config";
import { type Response } from "express";
import { AuthService } from "@present/http/auth/auth.service";
import { CreateUserOauthDto, LoginOauthUserDto, Payload, TokenDto } from "@app/auth/commands/dto";
