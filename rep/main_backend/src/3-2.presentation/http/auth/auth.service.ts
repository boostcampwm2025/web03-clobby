...
export class AuthService {
  ...
  public getAuthTokenKakaoUrl ( redirct_url : string ) : string {
    const rest_api_key : string = this.config.get<string>("NODE_APP_KAKAO_REST_API_KEY", "rest_api_key");
  ...
  public async getAccessTokenKakaoUrl ( code : string, redirect_url : string ) {
    ...
    const rest_api_key : string = this.config.get<string>("NODE_APP_KAKAO_REST_API_KEY", "rest_api_key");
    const clientSecret : string = this.config.get<string>("NODE_APP_KAKAO_CLIENT_SECRET", "client_secret");
