...
export class CardItem {
  ...
  constructor({
    item_id, card_id, type, x, y, width, height = undefined, rotation, scale_x, scale_y, opacity = undefined, z_index = undefined, is_locked = undefined, is_visible = undefined, name = undefined, created_at = new Date(), updated_at = new Date(), deleted_at
  } : CardItemProps) {
    ...
    this.is_locked = is_locked !== undefined ? cardItemIsLockedVo(is_locked) : undefined;
    this.is_visible = is_visible !== undefined ? cardItemIsVisibleVo(is_visible) : undefined;
    ...
    this.deleted_at = deleted_at && deleted_at instanceof Date ? deleted_at : undefined;

    Object.freeze(this);
  };

  getItemId() : CardItemProps["item_id"] { return this.item_id; };
  getCardId() : CardItemProps["card_id"] { return this.card_id; };
  getType() : CardItemProps["type"] { return this.type; };
  getX() : CardItemProps["x"] { return this.x; };
  getY() : CardItemProps["y"] { return this.y; };
  getWidth() : CardItemProps["width"] { return this.width; };
  getHeight() : CardItemProps["height"] { return this.height; };
  getRotation() : CardItemProps["rotation"] { return this.rotation; };
  getScaleX() : CardItemProps["scale_x"] { return this.scale_x; };
  getScaleY() : CardItemProps["scale_y"] { return this.scale_y; };
  getOpacity() : CardItemProps["opacity"] { return this.opacity; };
  getZindex() : CardItemProps["z_index"] { return this.z_index; };
  getIsLocked() : CardItemProps["is_locked"] { return this.is_locked; };
  getIsVisible() : CardItemProps["is_visible"] { return this.is_visible; };
  getName() : CardItemProps["name"] { return this.name; };
  getCreatedAt() : Exclude<CardItemProps["created_at"], undefined> { return this.created_at; };
  getUpdatedAt() : Exclude<CardItemProps["updated_at"], undefined> { return this.updated_at; };
  getDeltedAt() : CardItemProps["deleted_at"] { return this.deleted_at; };

  getData() : Required<Omit<CardItemProps, "deleted_at">> | Record<"deleted_at", CardItemProps["deleted_at"]> {
    return {
