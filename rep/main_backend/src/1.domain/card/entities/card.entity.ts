...
export class Card {
  ...
  constructor({ 
    card_id, user_id, category_id, thumbnail_path = undefined, status, title, workspace_width, workspace_height, background_color, created_at = new Date(), updated_at = new Date(),
    deleted_at = new Date()
   } : CardProps) {
  ...
  getCardId() : CardProps["card_id"] { return this.card_id; };
  getUserId() : CardProps["user_id"] { return this.user_id; };
  getCategoryId() : CardProps["category_id"] { return this.category_id; };
  getThumbnailPath() : CardProps["thumbnail_path"] { return this.thumbnail_path; };
  getStatus() : CardProps["status"] { return this.status; };
  getTitle() : CardProps["title"] { return this.title; };
  getWorkSpaceWidth() : CardProps["workspace_width"] { return this.workspace_width; };
  getWorkSpaceHeight() : CardProps["workspace_height"] { return this.workspace_height; };
  getBackgroundColor() : CardProps["background_color"] { return this.background_color; };
  getCreatedAt(): Exclude<CardProps['created_at'], undefined> {return this.created_at;};
