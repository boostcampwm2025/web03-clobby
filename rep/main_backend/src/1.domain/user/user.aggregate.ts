...
export type UpsertProfileInput = Pick<UserProfileProps, "user_id" | "profile_path" | "meme_type">;
...
export class UserAggregate {
  ...
  public getUserData() : UserProps { return this.user.getData() };
  public getUserId() : UserProps["user_id"] { return this.user.getUserId(); };
  public getOauthUser() : OauthUser | undefined { return this.oauthUser; };
  public getOauthUserData() : Required<OauthUserProps> | undefined { return this.oauthUser?.getData(); };
  public getProfile() : UserProfile | undefined { return this.profile };
  public getProfileData() : Required<UserProfileProps> | undefined { return this.profile?.getData() };
