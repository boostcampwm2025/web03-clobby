...
export class OauthUser {
  ...
  constructor({
    id, user_id, provider, provider_id, created_at = new Date(), updated_at = new Date()
  } : OauthUserProps) {
  ...
  public getId() : OauthUserProps["id"] { return this.id; };
  public getUserId() : OauthUserProps["user_id"] { return this.user_id; };
  public getProvider() : OauthUserProps["provider"] { return this.provider; };
  public getProviderId() : OauthUserProps["provider_id"] { return this.provider_id; };
  public getCreatedAt() : Exclude<OauthUserProps["created_at"], undefined> { return this.created_at; };
  public getUpdatedAt() : Exclude<OauthUserProps["updated_at"], undefined> { return this.updated_at; };
