import { userIdVo, emailVo, nicknameVo, passwordHashVo, type UserProps } from "@domain/user/user.vo";
...
export class User {
  ...
  constructor(
    { user_id, email, nickname, password_hash, created_at = new Date(), updated_at = new Date() } : UserProps ) 
  ...
  public getUserId() : UserProps["user_id"] { return this.user_id; };
  public getEmail() : UserProps["email"] { return this.email; };
  public getNickName() : UserProps["nickname"] { return this.nickname; };
  public getPasswordHash() : UserProps["password_hash"] { return this.password_hash; };
  public getCreatedAt() : Exclude<UserProps["created_at"], undefined> { return this.created_at; };
  public getUpdatedAt() : Exclude<UserProps["updated_at"], undefined> { return this.updated_at; };  
